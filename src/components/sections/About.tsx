...
const About: React.FC = () => {
  return (
    <section id="about" className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-gray-50 via-white to-emerald-50 relative overflow-hidden">
      {/* Decorative background elements */}
      <div className="absolute top-10 right-10 w-32 h-32 sm:w-64 sm:h-64 bg-gradient-to-r from-emerald-100 to-teal-100 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse"></div>
      <div className="absolute bottom-10 left-10 w-40 h-40 sm:w-80 sm:h-80 bg-gradient-to-r from-cyan-100 to-blue-100 rounded-full mix-blend-multiply filter blur-xl opacity-60 animate-pulse animation-delay-2000"></div>
      
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 sm:mb-12 lg:mb-16">
            <div className="inline-block px-4 py-2 sm:px-6 bg-gradient-to-r from-emerald-100 to-teal-100 text-emerald-800 rounded-full text-xs sm:text-sm font-semibold mb-4 shadow-lg border border-emerald-200">
              ✨ Personal Information ✨
            </div>
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-emerald-800 via-teal-700 to-cyan-800 bg-clip-text text-transparent mb-4">About Me</h2>
            <p className="text-gray-600 text-base sm:text-lg max-w-2xl mx-auto px-4">Get to know more about my personal details, qualifications, and Islamic lifestyle</p>
          </div>
          
          <div className="bg-gradient-to-br from-white via-gray-50 to-emerald-50 rounded-2xl sm:rounded-3xl shadow-2xl p-4 sm:p-6 md:p-8 lg:p-10 mb-8 sm:mb-12 border border-emerald-100 backdrop-blur-sm relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
              <div className="space-y-3 sm:space-y-4 lg:space-y-6">
                <div className="flex items-start gap-3 sm:gap-4 p-3 sm:p-4 bg-gradient-to-r from-white to-emerald-50 rounded-lg sm:rounded-xl shadow-md hover:shadow-lg transition-all duration-300 border border-emerald-100">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-full flex items-center justify-center shadow-lg flex-shrink-0">
                    <User className="text-white w-4 h-4 sm:w-6 sm:h-6" />
                  </div>
                  <div className="min-w-0">
                    <h3 className="text-emerald-700 text-xs sm:text-sm font-semibold uppercase tracking-wide">Full Name</h3>
                    <p className="font-bold text-gray-800 text-sm sm:text-base lg:text-lg">Mohammad Mainuddin</p>
                  </div>
                </div>
                
                <div className="flex items-start gap-3 sm:gap-4 p-3 sm:p-4 bg-gradient-to-r from-white to-teal-50 rounded-lg sm:rounded-xl shadow-md hover:shadow-lg transition-all duration-300 border border-teal-100">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-teal-500 to-cyan-500 rounded-full flex items-center justify-center shadow-lg flex-shrink-0">
                    <CalendarDays className="text-white w-4 h-4 sm:w-6 sm:h-6" />
                  </div>
                  <div className="min-w-0">
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-start gap-3 sm:gap-4 p-3 sm:p-4 bg-gradient-to-r from-white to-teal-50 rounded-lg sm:rounded-xl shadow-md hover:shadow-lg transition-all duration-300 border border-teal-100">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-teal-500 to-cyan-500 rounded-full flex items-center justify-center shadow-lg flex-shrink-0">
                    <Languages className="text-white w-4 h-4 sm:w-6 sm:h-6" />
                  </div>
                  <div className="min-w-0">
                    <h3 className="text-teal-700 text-xs sm:text-sm font-semibold uppercase tracking-wide">Languages Known</h3>
                    <p className="font-bold text-gray-800 text-sm sm:text-base lg:text-lg">🗣️ Urdu, Arabic, English & Hindi</p>
                  </div>
                </div>
          ...
          <div className="bg-gradient-to-br from-white via-emerald-50 to-teal-50 rounded-2xl shadow-2xl p-4 sm:p-6 lg:p-8 border border-emerald-100 relative overflow-hidden">
            {/* Decorative background elements */}
            ...
            <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold bg-gradient-to-r from-emerald-700 via-teal-600 to-green-600 bg-clip-text text-transparent mb-4 sm:mb-6 lg:mb-8 flex items-center gap-2 sm:gap-3 relative z-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 lg:gap-6 relative z-10">
              <div className="flex items-center gap-3 sm:gap-4 bg-gradient-to-r from-white to-emerald-50 p-3 sm:p-4 lg:p-6 rounded-lg sm:rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-emerald-200">
                <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 rounded-full bg-gradient-to-r from-emerald-500 to-teal-500 flex items-center justify-center shadow-lg flex-shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-white sm:w-5 sm:h-5 lg:w-6 lg:h-6">
                ...
                <span className="font-bold text-gray-800 text-sm sm:text-base lg:text-lg">🕌 Practicing 5 daily prayers</span>
              </div>
              
              <div className="flex items-center gap-3 sm:gap-4 bg-gradient-to-r from-white to-teal-50 p-3 sm:p-4 lg:p-6 rounded-lg sm:rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-teal-200">
                <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 rounded-full bg-gradient-to-r from-teal-500 to-cyan-500 flex items-center justify-center shadow-lg flex-shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-white sm:w-5 sm:h-5 lg:w-6 lg:h-6">
                ...
                <span className="font-bold text-gray-800 text-sm sm:text-base lg:text-lg">📖 Qur'an recitation with Tajweed</span>
              </div>
              
              <div className="flex items-center gap-3 sm:gap-4 bg-gradient-to-r from-white to-green-50 p-3 sm:p-4 lg:p-6 rounded-lg sm:rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-green-200">
                <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 rounded-full bg-gradient-to-r from-green-500 to-emerald-500 flex items-center justify-center shadow-lg flex-shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-white sm:w-5 sm:h-5 lg:w-6 lg:h-6">
                    <path d="M19 15V9"/>
                    <path d="M5 15V9"/>
                    <path d="M12 4V20"/>
                ...
                <span className="font-bold text-gray-800 text-sm sm:text-base lg:text-lg">✨ Maintains Halal lifestyle</span>
              </div>
              
              <div className="flex items-center gap-3 sm:gap-4 bg-gradient-to-r from-white to-blue-50 p-3 sm:p-4 lg:p-6 rounded-lg sm:rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-blue-200">
                <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 rounded-full bg-gradient-to-r from-blue-500 to-indigo-500 flex items-center justify-center shadow-lg flex-shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-white sm:w-5 sm:h-5 lg:w-6 lg:h-6">
                ...
                <span className="font-bold text-gray-800 text-sm sm:text-base lg:text-lg">👨‍👩‍👧‍👦 Traditional family values</span>
              </div>
            </div>
          </div>
        </div>
